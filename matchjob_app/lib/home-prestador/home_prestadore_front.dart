...
class HomePrestadorFront extends StatefulWidget {
  ...
  HomePrestadorFront({this.controller});

  @override
  _HomePrestadorFrontState createState() => new _HomePrestadorFrontState();
}

class _HomePrestadorFrontState extends State<HomePrestadorFront> {
...
class BodyWidget extends StatelessWidget {
  ...
  void navigateToView(BuildContext context, String navigationKey) {
    Navigator.push(
      ...
      PageRouteBuilder(
        pageBuilder: (context, animation1, animation2) {
          if (navigationKey == "vagasListagem") {
            return VagaListagemTodas();
          } else {
            return MinhasVagas();
          }
        },
